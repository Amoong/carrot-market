  ...
  return (
    <div className="bg-slate-400 xl:place-content-center py-20 px-20 grid gap-10 lg:grid-cols-2 xl:grid-cols-3 min-h-screen">
      <div className="bg-white dark:bg-black flex flex-col justify-between p-6 rounded-3xl shadow-xl">
        ...
        <button
          className="mt-5 bg-blue-500 dark:bg-black dark:border-white dark:border-2 text-white p-3
          text-center rounded-xl w-3/4 block mx-auto dark:hover:bg-white dark:hover:text-black
      ...
      <div className="bg-white overflow-hidden rounded-3xl shadow-xl group">
        <div className="portrait:bg-indigo-300 landscape:bg-teal-400 xl:pb-52 p-6 pb-14">
