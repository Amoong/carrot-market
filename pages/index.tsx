  ...
  return (
    <div className="bg-slate-400 py-20 px-20 grid gap-10 min-h-screen">
      <div className="bg-white p-6 rounded-2xl shadow-xl">
        ...
        <button className="mt-5 w-full bg-blue-500 text-white p-3 text-center rounded-xl mx-auto hover:bg-teal-500 hover:text-black active:bg-yellow-500 focus:bg-red-500">
          Checkout
        </button>
      </div>
      ...
      <div className="bg-white overflow-hidden rounded-3xl shadow-xl p-6">
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-3 mb-5 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-5">
              <button className="bg-blue-200 flex justify-center items-center aspect-square w-8 font-medium text-xl text-gray-500 rounded-lg">
                -
              </button>
              <span>1</span>
              <button className="bg-blue-200 flex justify-center items-center aspect-square w-8 font-medium text-xl text-gray-500 rounded-lg">
        ...
        <div className="flex justify-between items-center">
          ...
          <button className="bg-blue-500 text-center text-white p-3 rounded-lg py-2 px-8 text-sm">
            Add to cart
          </button>
        </div>
      </div>
