  ...
  return (
    <div className="space-y-4 py-10 px-4">
      <div className="flex items-center space-x-3">
        ...
        <label
          htmlFor="picture"
          className="cursor-pointer rounded-md border border-gray-300 py-2 px-3 text-sm font-medium text-gray-500 shadow-sm"
        >
          Change
      ...
      <button className="mt-6 w-full rounded-md border border-transparent bg-orange-500 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2">
        Update profile
      </button>
    </div>
  );
